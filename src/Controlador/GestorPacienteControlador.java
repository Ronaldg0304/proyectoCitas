 ...
 * @author rolan
 */
public class GestorPacienteControlador implements ActionListener {

    Modelo.GestorPaciente pacientesModelo;
    Vista.ConsPacienteInternalFrame consultarPacienteVista;

    public GestorPacienteControlador(Vista.ConsPacienteInternalFrame consultarPacienteVista) {
